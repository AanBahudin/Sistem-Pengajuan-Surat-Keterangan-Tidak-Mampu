...
import { FileText, FileCheck2, FileCog, FileWarning, FolderCheck, History } from 'lucide-react'
...
export const loader = async() => {
  try {
    const { data } = await customFetch.get('/rt/stats')
    return data
  } catch (error) {
...
const DashboardRT = () => {
  ...
  const { ajuan: data, statusSummary, totalData } = useLoaderData()  
