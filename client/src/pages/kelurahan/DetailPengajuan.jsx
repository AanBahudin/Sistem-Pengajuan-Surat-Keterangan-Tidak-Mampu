...
import { DataContainer, BigDataContainer, ImageViewer, FormTextarea, RtAndKelurahanMap } from '../../components'
      ...
      <section className='w-full h-full rounded-xl p-4'>
        <div className='w-full flex items-center justify-between'>
          ...
          {data.statusAccKelurahan === 'terima' ? (
            <p  className='flex items-center gap-x-4 bg-newBlue/80 px-6 py-2 rounded-lg text-sm text-white'>
              Diterima
            </p>
          ) : null}
        </div>
